...
function destacarCelulasComConteudoOmisso() {
    ...
    for(const c of celulas) {
        ...
        if (c.clientWidth < 55 && c.value.length > 6) {
            ...
            celulasSaturadas++;
        } else if (c.clientWidth < 83 && c.value.length > 10) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if (c.clientWidth < 86 && c.value.length > 10) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if (c.clientWidth < 106 && c.value.length > 13) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        }
    }
