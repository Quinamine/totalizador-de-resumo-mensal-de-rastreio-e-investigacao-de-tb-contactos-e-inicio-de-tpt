...
const menu = {
    ...
    imprimirFicha() {
        ...
        let inputsCelulares = document.querySelectorAll("[data-totaleixoyoutput], .input-celular--focus");
        let icPreenchidas = 0;
        let totalizadoPor;
...
function eventos() {
    ...
    // PARTILHAR 
    const data = {
        title: "Totalizador de Resumo Mensal de Rastreio e Investigação de TB, Contactos e Início de TPT",
        text: "Totaliza automaticamente o resumo mensal de rastreio e investigação de TB, contactos e início de TPT com base nos dados inseridos pelo usuário. Foi desenvolvido de acordo com o modelo da respectiva ficha de resumo mensal actualmente vigente no Serviço Nacional de Saúde em Moçambique.",
        url: "https://quinamine.github.io/totalizador-de-resumo-mensal-de-rastreio-e-investigacao-de-tb-contactos-e-inicio-de-tpt/index.html"
    }
